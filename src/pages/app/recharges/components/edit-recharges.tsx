...
interface RechargesDataProps {
  onDataRecharges: GetRechargesResponse;
}

export function EditRecharges({ onDataRecharges }: RechargesDataProps) {
  console.log(onDataRecharges);
